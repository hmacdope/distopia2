...
auto CalcBondsOrthoD_pointer = &CalcBondsOrthoDispatchD;
                             ...
                             const float *box, std::size_t n, float *out)
{
    ...
    else if (iset >= 8 && _SIMD_config.has_AVX2)
    {
        ...
        _DISPATCH_fptr_register.set_ptr<0, CalcBondsOrtho_FptrT>(&Ns_AVX2::CalcBondsOrtho); // AVX2
#endif
    }
    else if (iset >= 7 && _SIMD_config.has_AVX)
    {
#if DISTOPIA_AVX_AVAILABLE
        _DISPATCH_fptr_register.set_ptr<0, CalcBondsOrtho_FptrT>(&Ns_AVX::CalcBondsOrtho); // AVX
#endif
    }
    else if (iset >= 6 && _SIMD_config.has_SSE4_2)
    {
#if DISTOPIA_SSE4_2_AVAILABLE
        _DISPATCH_fptr_register.set_ptr<0, CalcBondsOrtho_FptrT>(&Ns_SSE4_2::CalcBondsOrtho); // SSE4.2
#endif
    }
    else if (iset >= 5 && _SIMD_config.has_SSE4_1)
    {
#if DISTOPIA_SSE4_1_AVAILABLE
        _DISPATCH_fptr_register.set_ptr<0, CalcBondsOrtho_FptrT>(&Ns_SSE4_1::CalcBondsOrtho); // SSE4.1
#endif
    }
    else if (iset >= 4 && _SIMD_config.has_SSSE3)
    {
#if DISTOPIA_SSSE3_AVAILABLE
        _DISPATCH_fptr_register.set_ptr<0, CalcBondsOrtho_FptrT>(&Ns_SSSE3::CalcBondsOrtho); // SSSE3
#endif
    }
    else if (iset >= 3 && _SIMD_config.has_SSE3)
    {
#if DISTOPIA_SSE3_AVAILABLE
        _DISPATCH_fptr_register.set_ptr<0, CalcBondsOrtho_FptrT>(&Ns_SSE3::CalcBondsOrtho); // SSE3
#endif
    }
    else if (iset >= 2 && _SIMD_config.has_SSE2)
    {
#if DISTOPIA_SSE2_AVAILABLE
        _DISPATCH_fptr_register.set_ptr<0, CalcBondsOrtho_FptrT>(&Ns_SSE2::CalcBondsOrtho); // SSE2
#endif
    }
...
// this should always be the case
        ...
        _DISPATCH_fptr_register.set_ptr<0, CalcBondsOrtho_FptrT>(&Ns_SSE1::CalcBondsOrtho); // SSE1
#endif
    }
    // continue in the dispatched version of the entry function
    (*_DISPATCH_fptr_register.get_ptr<0>())(coords0, coords1, box, n, out);
}
