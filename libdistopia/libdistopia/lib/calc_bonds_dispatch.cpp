...
float myfunc_dispatch(float const f[]) {
    ...
    if      (iset >= 9) myfunc_pointer = &Ns_AVX512::myfunc;  // AVX512 version
    else if (iset >= 8) myfunc_pointer = &Ns_AVX2::myfunc;  // AVX2 version                                // AVX2 version
    else if (iset >= 7) myfunc_pointer = &Ns_AVX::myfunc;   // AVX version
    else if (iset >=  6) myfunc_pointer = &Ns_AVX::myfunc;     
    else if (iset >=  5) myfunc_pointer = &Ns_AVX::myfunc;     
